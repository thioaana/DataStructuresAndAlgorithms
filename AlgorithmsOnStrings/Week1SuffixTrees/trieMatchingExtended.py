...
# Build a Trie where a pattern may be a prefix of another pattern
    ...
    for pat in patterns:
        ...
        for i in range(len(pat)):
            ...
            if i == len(pat) - 1 :                         # Reached the end of the pattern.
                tree[currentNode][currentNode + 1] = "$"   # The $ sign is added as a flag indicating that a pattern i reached to the end.
